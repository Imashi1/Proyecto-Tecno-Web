<?php
    ...
    //Proceso para eliminar la imagen de la carpeta /img/
    if (isset($imagen) && ($imagen != "notfound.jpg")) {

        //Si existe el archivo con nombre $imagen en carpeta /img/
    ...
    if ($conn->query($borrar_fila) === TRUE) {
        //Redireccionamos a la pagina donde se muestra todas las tiendas
