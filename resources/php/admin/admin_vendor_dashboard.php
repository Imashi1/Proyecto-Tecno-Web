                ...
                <div id="map">
                    <script>
                        ...
                        const map = new mapboxgl.Map({
                            ...
                            center: [-70.29613247361456, -18.489965686232765], // Posición Inicial
                            zoom: 16.5, 
                            maxZoom: 16.5,
                            minZoom: 16.5,
                        ...
                        //Procedemos a colocar marcadores usando las ubicaciones guardadas.
                        <?php foreach ($ubicaciones as $ubicacion) { ?>
