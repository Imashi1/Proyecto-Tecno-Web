...
<body>
    ...
    //de la forma '$producto['nombreColumna'];
    ...
    <div class="container">
        ...
        <form action="admin_user_edit_trigger.php" class="bg-light my-3 p-3 border rounded" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $producto['nombre']; ?>" name="nombre" id="nombre" required>
            </div>

            <div class="form-group">
                <label for="apelido">Apellido:</label>
                <input type="text" class="form-control" value="<?php echo $producto['apellido']; ?>" name="apellido" id="apellido" required>
            </div>

            <div class="form-group">
                <label for="email">Correo Electrónico:</label>
                <input type="email" class="form-control" value="<?php echo $producto['correo']; ?>" name="email" id="email" required>
            </div>

            <div class="form-group">
                <label for="pass">Contraseña:</label>
                <input type="password" class="form-control" value="<?php echo $producto['contrasena']; ?>" name="pass" id="pass" required>
            </div>

            <!--Input extra escondido para obtener el id y con el, poder utilizarlo en editar.php-->
            <input type="hidden" class="form-control" value="<?php echo $producto['id']; ?>" name="id">
